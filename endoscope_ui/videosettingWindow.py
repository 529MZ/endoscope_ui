...
from ui.videosettings import *

class videosettingWindow(QDialog):
    videoSettingsChanged = pyqtSignal(str, str, str)
    def __init__(self):
        super().__init__()
    ...
    def accept(self):
        ...
        resolution = self.ui.videoResolutionBox.currentText()
        codec = self.ui.videoCodecBox.currentText()
        framerate = self.ui.videoFramerateBox.currentText()


        self.videoSettingsChanged.emit(resolution, codec, framerate)
